...
As of 10/10/2022, there are 2 component files of the ImagesLoaderV5.tbx.
...
This script creates a new directory of 'smaller' images (WITH Metadata) from an existing directory of images. It also creates a mosaic file that 
